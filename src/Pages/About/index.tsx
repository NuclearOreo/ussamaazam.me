  ...
  return (
    <div className={style}>
      <div className="aboutMeStyle">
        Hey, my name is Ussama Azam, and I&apos;m a young software engineer early in my career.
        I have many interests that range from photography to random technical stuff to more random
        ...
        since I learned about Y Combinator and constantly reading the great blogs that always pop
        up on the site, I&apos;ve decided to attempt writing blogs. The whole goal of this website
        is to motivate me to start writing blogs (hopefully become a better writer in the process)
        and showcase my photos from my photography venture. Maybe I&apos;ll decide to go out of my
        way to showcase the exciting stuff I made, like the stupid donut on my home page.
      </div>
